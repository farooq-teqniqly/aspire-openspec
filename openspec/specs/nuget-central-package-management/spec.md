...
NuGet Central Package Management (CPM) for this repository: one `Directory.Packages.props`, versionless `PackageReference` in Aspire projects, and unchanged AppHost SDK versioning.
